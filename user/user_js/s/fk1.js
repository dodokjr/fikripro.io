...
document.cookie = "username=_1jpr; expires=Thu, 30 dess 2025 00:00:00 UTC; path=/";
document.cookie = "username=ValueMax091; expires=Thu, 30 dess 2022 00:00:00 UTC; path=/";
...
function utf(){
  var utf = $('utfnew').value.toLowerCase();
  var text = $('utftex').value.toLowerCase();
}

function untg(){
  var untg = $('coonetc').value.textContent();
}
...
*/
    ...
    ;
    function ra(a) {
            if (a instanceof qa && a.constructor === qa)
                    return a.g;
            var b = typeof a;
            na("expected object of type SafeHtml, got '" + a + "' of type " + ("object" != b ? b : a ? Array.isArray(a) ? "array" : b : "null"));
    ...
    function xa(a, b) {
            if (a.tagName && va[a.tagName.toUpperCase()])
    ...
    ;function Ha(a) {
            a.data && Ea(a.data) && 0 == a.data.lastIndexOf("spf:", 0) && Ia(a.data.substring(4))
    }
    function Ia(a) {
            var b = Ja[a];
            b && (delete Ja[a],
    ...
    Ja = x["async-defers"];
    Ma && ("async-listener"in x && La(x["async-listener"]),
    Ka(Ha),
    w("async-listener", Ha));
    var Na = {
    ...
    function E(a, b) {
            b && (a.classList ? a.classList.add(b) : Ta(a, b) || (a.className += " " + b))
    }
    function F(a, b) {
            if (b)
                    if (a.classList)
    ...
    function $a(a, b, c, d) {
            if (b || c) {
                    ...
                    if (a)
                            ab(c, b);
                    else if (a = bb().contentWindow.history.pushState,
                    "function" == typeof a)
    ...
    function cb(a) {
            ...
            if (x["history-ignore-pop"])
                    w("history-ignore-pop", !1);
            else if (a.state) {
                    a = a.state;
                    var c = a["spf-timestamp"];
                    b == x["history-url"] ? (w("history-timestamp", c),
                    ab(a, b)) : (a["spf-back"] = c < parseInt(x["history-timestamp"], 10),
    ...
    function ab(a, b) {
            var c = bb().contentWindow.history.replaceState;
    ...
    function eb(a, b) {
            a in G && b && Aa(G[a], function(c, d, e) {
                    return c == b ? (e[d] = null,
                    !1) : !0
            })
    }
    ...
    function lb(a, b, c) {
            b.delay ? (c = n(c, null, za),
            a.v = setTimeout(c, b.delay),
            b.delay = 0) : (a.items.shift(),
            c = n(c, null, b.I),
            (b = (b = A["advanced-task-scheduler"]) && b.addTask) ? a.A = b(c) : a.v = setTimeout(c, 0))
    }
    function kb(a) {
            if (a.A) {
    ...
    ;function pb(a, b, c, d) {
            ...
            e && delete S[P(a, e)],
            delete G[P(a, c)],
            db(g, n(qb, null, a, c, h)));
            if ((e = S[P(a, b)]) && f != e) {
                    delete Q[P(a, e)];
                    delete S[P(a, b)];
                    var k = P(a, e);
                    k && g && k in G && (G[g] = (G[g] || []).concat(G[k]),
                    delete G[k])
            }
            S[P(a, b)] = f;
            Q[P(a, f)] = b;
            db(g, d);
            d = n(rb, null, a);
            T[P(a, b, void 0)] ? (e && f != e && (a = sb(a, b)) && a.setAttribute("name", c || ""),
            d()) : (a = tb(a, b, d, void 0, void 0, h)) && c && a.setAttribute("name", c)
    }
    function ub(a, b) {
            var c = Q[P(a, b)];
            delete Q[P(a, b)];
    ...
    function rb(a) {
            var b = P(a, ""), c;
            for (c in G)
                    0 == c.indexOf(b) && Aa(c.substring(b.length).split("|"), n(wb, null, a)) && fb(c)
    }
    function tb(a, b, c, d, e, f) {
            ...
            h ? (m.async = !0,
            m.src = b,
            d.insertBefore(m, d.firstChild)) : (m.rel = "stylesheet",
            m.href = b,
            (f = f ? sb(a, f, d) : null) ? d.insertBefore(m, f) : d.appendChild(m));
            return m
    }
    function vb(a, b) {
            b = O(a, b);
    ...
    function yb(a) {
            var b = "js" == a
              , c = [];
            r(Va(b ? "script[src]" : 'link[rel~="stylesheet"]'), function(d) {
    ...
    function zb(a, b, c) {
            ...
            c || !T[P(a, b, void 0)]))
                    if (c && "img" == a)
                            ...
                            if (!d)
                                    d = Ya(f, null, function(g) {
                                            g.title = f;
                                            L(f, !0)
                                    });
                            else if (!c && d.contentWindow.document.getElementById(e))
                                    return;
    ...
    function Bb(a, b, c, d, e) {
            ...
            f ? (h = a.createElement("object"),
            Cb ? a.createElement("script").src = c : h.data = c,
            h.id = d,
            a.body.appendChild(h)) : g ? (h = tb(b, c, null, a, e),
            h.id = d) : (h = a.createElement("img"),
            Cb && (c = c + "#" + q()),
            h.src = c,
            h.id = d,
    ...
    function Db(a, b, c) {
            ...
            for (var g = 0, h = 0, k = f.length; h < k; ++h)
                    g = 31 * g + f.charCodeAt(h),
                    g %= 4294967296;
            f = "hash-" + g;
            Q[P(a, c)] = f;
            !Eb(a, f) && (b = Fb(a, b)) && (T[P(a, f, void 0)] = 2,
            b && !d && (d = xb(f),
            b.className = P(a, d),
    ...
    function Fb(a, b) {
            ...
            "js" == a ? (a = document.createElement("script"),
            a.text = b,
            c.appendChild(a),
            c.removeChild(a)) : (a = document.createElement("style"),
            c.appendChild(a),
            "styleSheet"in a ? a.styleSheet.cssText = b : a.appendChild(document.createTextNode(b)));
            return a
    }
    function O(a, b) {
            var c = "rsrc-p-" + a;
    ...
    function Lb(a, b, c) {
            ...
            var e = !d.length;
            if (b) {
                    var f = Aa(a, n(wb, null, "js"));
                    e && f ? b() : (a = P("js", a.sort().join("|")),
                    db(a, b))
            }
            c && !e && c(d)
    }
    ...
    ;function Vb(a, b, c) {
            if (b) {
                    ...
                    for (-1 < e && (d = e + 3); -1 < (e = a.indexOf(",\r\n", d)); ) {
                            var f = Fa(a.substring(d, e));
                            d = e + 3;
                            f && b.push(JSON.parse(f))
                    }
                    e = a.indexOf("]\r\n", d);
                    -1 < e && (f = Fa(a.substring(d, e)),
                    d = e + 3,
                    f && b.push(JSON.parse(f)));
                    f = "";
                    a.length > d && (f = a.substring(d),
    ...
    function V(a, b, c, d) {
            ...
            b.attr && (u = n(function(t, C) {
                    for (var H in t) {
                            ...
                            if (M) {
                                    ...
                                    for (R in $b) {
                                            var ua = $b[R];
                                            "class" == R ? M.className = ua : "style" == R ? M.style.cssText = ua : (M.setAttribute(R, ua),
                                            "value" == R && (M[R] = ua))
                                    }
                            }
                    }
                    C.spfProcessAttr = q()
            }, null, b.attr, b.timing),
            u = J(m, u));
            var I = b.body || {}, $c = u, Wa;
            for (Wa in I)
                    u = n(function(t, C) {
                            if (t = document.getElementById(t)) {
                                    !e || g || h || (w("nav-scroll-position", null),
                                    ...
                                    C = A["animation-class"];
                                    ac && Ta(t, C) ? (t = new bc(t,H.html,C,k,!!f),
                                    hb(m),
                                    L(t.key, !0),
                                    J(t.key, n(cc, null, t), 0),
                                    J(t.key, n(dc, null, t), 17),
                                    J(t.key, n(ec, null, t), t.duration),
                                    J(t.key, n(function() {
                                            M();
                                            ib(m, B)
                                    }, null), 0),
                                    L(t.key)) : (C = A["experimental-html-handler"]) ? (hb(m),
                                    C(H.html, t, function() {
                                            M();
                                            ib(m, B)
                                    })) : (xa(t, sa(H.html)),
            ...
            }, null, b.foot, b.timing, I),
            u = J(m, u)) : I && (u = n(function(t) {
                    t.spfProcessBody = q()
            }, null, b.timing),
            u = J(m, u));
    ...
    function cc(a) {
            ...
            xa(a.j, sa(a.U));
            a.reverse ? (b = a.u,
            b.parentNode.insertBefore(a.j, b)) : (b = a.u,
            b.parentNode.insertBefore(a.j, b.nextSibling))
    }
    function dc(a) {
            F(a.g, a.P);
            F(a.g, a.S);
    ...
    function W(a) {
            ...
            if (!a)
                    return b;
            if (!Ea(a))
                    return a.scripts && r(a.scripts, function(c) {
                            b.scripts.push({
                                    url: c.url || "",
                                    text: c.text || "",
                                    name: c.name || "",
            ...
            a = a.replace(jc, function(c, d, e, f) {
                    ...
                    return "style" == d && (d = (d = e.match(kc)) ? d[1] : "",
                    e = nc.exec(e),
                    e = !e || -1 != e[1].indexOf("text/css")) ? (b.styles.push({
                            url: "",
                            text: f,
                            name: d
                    }),
            ...
            a = a.replace(oc, function(c, d) {
                    var e = d.match(pc);
                    e = e ? e[1] : "";
                    return "stylesheet" == e ? (e = (e = d.match(kc)) ? e[1] : "",
                    d = (d = d.match(qc)) ? d[1] : "",
                    b.styles.push({
                            url: d,
                            text: "",
                    ...
                    "") : "spf-preconnect" == e ? (d = (d = d.match(qc)) ? d[1] : "",
                    b.links.push({
                            url: d,
                            rel: e
                    }),
    ...
    function hc(a) {
            0 >= a.scripts.length || (a = Da(a.scripts, function(b) {
                    return b.url
            }),
            Kb(a))
    }
    function Yb(a) {
            0 >= a.styles.length || r(a.styles, function(b) {
                    b.url ? b.name ? Sb(b.url, b.name) : Tb(b.url) : b.text && (b.name ? Db("css", b.text, b.name) : Fb("css", b.text))
            })
    }
    function gc(a) {
            0 >= a.styles.length || (a = Da(a.styles, function(b) {
                    return b.url
            }),
            Ub(a))
    }
    function Xb(a) {
            0 >= a.links.length || (a = Da(a.links, function(b) {
    ...
    var ac = function() {
            var a = document.createElement("div");
            return "transition"in a.style ? !0 : Ba(["webkit", "Moz", "Ms", "O", "Khtml"], function(b) {
...
*/
    function rc(a, b, c, d) {
            ...
            k.onreadystatechange = function() {
                    ...
                    if (2 == k.readyState) {
                            ...
                            if ("json" == k.responseType)
                                    f = !1;
                            else if (A["assume-all-json-requests-chunked"] || -1 < (k.getResponseHeader("Transfer-Encoding") || "").toLowerCase().indexOf("chunked"))
                                    f = !0;
                            else {
                            ...
                            3 == k.readyState ? f && e.C && (u = k.responseText.substring(g),
                            g = k.responseText.length,
                            e.C(k, u)) : 4 == k.readyState && (u.responseEnd = u.responseEnd || q(),
                            window.performance && window.performance.getEntriesByName && (k.resourceTiming = window.performance.getEntriesByName(b).pop()),
                            f && e.C && k.responseText.length > g && (u = k.responseText.substring(g),
                            g = k.responseText.length,
                            e.C(k, u)),
                            clearTimeout(h),
                            e.M && e.M(k))
            ...
            ;
            "responseType"in k && "json" == e.responseType && (k.responseType = "json");
    ...
    ;function sc(a, b) {
            ...
            if (d) {
                    ...
                    if (0 == d.lastIndexOf("?", 0))
                            ...
                            if (0 == d.lastIndexOf(".", 0))
                                    ...
                                    y(c, "/") && 0 == d.lastIndexOf("/", 0) && (d = d.substring(1));
                            c += d
                    }
                    c = c + g + f + h + e
            }
            ...
            c.spfCached = !!g;
            if (g) {
                    a = n(vc, null, a, b, c, g.key, g.response);
                    b = window._spf_state = window._spf_state || {};
                    var m = parseInt(b.uid, 10) || 0;
                    m++;
                    b = b.uid = m;
                    Ja[b] = a;
                    Ma ? window.postMessage("spf:" + b, "*") : window.setTimeout(n(Ia, null, b), 0);
                    return null
            }
            g = {};
    ...
    function xc(a, b, c, d, e) {
            ...
            if (e.resourceTiming)
                    ...
                    f + e.resourceTiming.startTime >= c.startTime))
                            for (var h in e.resourceTiming)
                                    ...
                                    void 0 !== g && (y(h, "Start") || y(h, "End") || "startTime" == h) && (c[h] = f + Math.round(g));
            "load" != b.type && (c.navigationStart = c.startTime);
            d.g.length && (d.l = Fa(d.l),
            d.l && zc(a, b, c, d, e, "", !0));
            if ("json" == e.responseType) {
                    ...
                    var k = Wb(v(e.response))
            } else
                    try {
                            k = Vb(e.responseText).F
                    } catch (B) {
                            b.m && b.m(a, B, e);
                            return
                    }
    ...
    function Ac(a, b, c, d, e) {
            if (e && "POST" != b.method && (e = tc(a, b.current, d.cacheType, b.type, !0))) {
                    d.cacheKey = e;
                    var f = {
                            response: d,
                            type: b.type || ""
    ...
    function tc(a, b, c, d, e) {
            ...
            b && "url" == c ? f += " previous " + b : b && "path" == c && (f += " previous " + mb(b).pathname);
            return f || ""
    }
    function uc(a, b) {
            var c = [];
            b && (c.push(a + " previous " + b),
            c.push(a + " previous " + mb(b).pathname));
            c.push(a);
            var d = null;
            Ba(c, function(e) {
                    a: {
    ...
    ;function Bc(a) {
            return Xa(a, function(b) {
                    return Ta(b, A["link-class"])
            })
    }
    function Cc(a) {
            return Xa(a, function(b) {
                    return Ta(b, A["nolink-class"])
            })
    }
    function Dc(a, b) {
    ...
    function Ec(a) {
            if (a.metaKey || a.altKey || a.ctrlKey || a.shiftKey || 0 < a.button)
                    return null;
            var b = Bc(a.target);
            return !b || A["nolink-class"] && Cc(a.target) ? null : (a = Dc(a.target, b)) ? a.href : null
    }
    function Fc(a) {
            return mb(a).origin != mb(window.location.href).origin ? !1 : !0
    }
    function Gc() {
            if (!x["nav-init"])
                    return !1;
    ...
    function Pc(a, b) {
            ...
            c && (a = nb(a, [c]));
            Fc(a) ? Gc() ? p("spfhistory", {
                    url: a,
                    referer: b.i,
                    previous: b.current
            }) && (b.position && (w("nav-scroll-position", [window.pageXOffset, window.pageYOffset]),
            ...
            if (Hc(a, c.current))
                    if (Rc(a, c.i, c.current, b)) {
                            ...
                            var d = N(a)
                              , e = "preprocess " + N(d);
                            for (f in K)
                                    e != f && 0 == f.lastIndexOf("preprocess", 0) && jb(f);
                            d = Tc()[d];
                            w("nav-request", d);
                            w("nav-promote", null);
    ...
    function Yc(a, b) {
            if (b.position)
                    Oc(),
                    window.scroll.apply(null, b.position),
                    b.s = !0;
            else if (a = z(a, "#"),
            a[2]) {
    ...
    function Uc(a, b, c) {
            try {
                    ...
                    N(a, !0) != window.location.href && $a(!1, a, {
                            "spf-referer": b
                    }, void 0)
            } catch (d) {
                    Qc(),
    ...
    function X(a, b, c) {
            ...
            A["experimental-remove-history"] && e == a && (w("history-ignore-pop", !0),
            window.history.back());
            setTimeout(function() {
                    ...
                    Hc(a, e) || window.location.reload()
            }, 0)
    }
    function fd(a, b, c) {
            c.h = c.h || a;
            if (Rc(a, void 0, void 0, b, !0)) {
                    var d = n(gd, null, !1, b, c)
                      , e = n(hd, null, !1, b, c)
                      , f = n(id, null, !1, b, c);
                    c.type = "load";
                    sc(a, {
    ...
    ;function nd() {
            yb("js");
            yb("css");
            "complete" == document.readyState && (document.removeEventListener ? document.removeEventListener("DOMContentLoaded", nd, !1) : document.detachEvent && document.detachEvent("onreadystatechange", nd))
    }
    ...
    var od = {
            init: function(a) {
                    ...
                    if (b) {
                            ...
                            !x["nav-init"] && document.addEventListener && (w("nav-init", !0),
                            w("nav-init-time", q()),
                            w("nav-counter", 0),
                            document.addEventListener("click", Ic, !1),
                            w("nav-listener", Ic),
                            !A["experimental-prefetch-mousedown"] || "ontouchstart"in window || 0 < window.navigator.maxTouchPoints || 0 < window.navigator.msMaxTouchPoints || (document.addEventListener("mousedown", Lc, !1),
                            w("nav-mousedown-listener", Lc)),
                            document.addEventListener("scroll", Nc, !1),
                            w("nav-scroll-listener", Nc))
                    }
                    return b
            },
            dispose: function() {
                    "undefined" != typeof History && History.prototype.pushState && (Qc(),
                    x["nav-init"] && (document.removeEventListener && (document.removeEventListener("click", x["nav-listener"], !1),
                    document.removeEventListener("mousedown", x["nav-mousedown-listener"], !1),
                    document.removeEventListener("scroll", x["nav-scroll-listener"], !1)),
                    w("nav-listener", null),
                    ...
                    w("nav-counter", null)),
                    x["history-init"] && (window.removeEventListener && window.removeEventListener("popstate", x["history-listener"], !1),
                    w("history-init", !1),
            ...
            navigate: function(a, b) {
                    a && (a = ob(a),
                    Fc(a) ? Gc() ? Jc(a, b || {}, new Kc) : X(a, "1") : X(a, "9"))
            },
            load: function(a, b) {
                    a = ob(a);
                    fd(a, b || {}, new Kc)
...
function myFunction() {
  document.getElementById("rootq").innerHTML = "About Blank!!!";
}
...
(function(f, h) {
  ...
  if ("IntersectionObserver"in f && "IntersectionObserverEntry"in f && "intersectionRatio"in f.IntersectionObserverEntry.prototype)
          "isIntersecting"in f.IntersectionObserverEntry.prototype || Object.defineProperty(f.IntersectionObserverEntry.prototype, "isIntersecting", {
                  get: function() {
          ...
          d.prototype.K = function() {
                  this.l || (this.l = !0,
                  this.m ? this.o = setInterval(this.g, this.m) : (u(f, "resize", this.g, !0),
                  u(h, "scroll", this.g, !0),
                  this.C && "MutationObserver"in f && (this.j = new MutationObserver(this.g),
                  this.j.observe(h, {
                          attributes: !0,
                          childList: !0,
                          characterData: !0,
                  ...
                  if ("none" != f.getComputedStyle(a).display) {
                          ...
                          for (var e = !1; !e; ) {
                                  ...
                                  if ("none" == k.display)
                                          return;
                                  a == this.root || a == h ? (e = !0,
                                  g = b) : a != h.body && a != h.documentElement && "visible" != k.overflow && (g = m(a));
                                  if (g) {
...
var cookieName= "_PUSR";
var cookieValue="Puhs";
